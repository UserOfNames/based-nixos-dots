...
do
    local __nixvim_binds = {
        ...
        { action = "<cmd>Telescope live_grep<cr>", key = "<Leader>fs", mode = "n" },
        {
            ...
            key = "<Leader>os",
            mode = { "n" },
            options = { desc = "Toggle spellcheck", noremap = true, silent = true },
        },
        {
            action = function()
            ...
            key = "<Leader>ow",
            mode = { "n" },
            options = { desc = "Toggle word wrap", noremap = true, silent = true },
        },
        {
            action = "<C-g>u<Esc>[s1z=`]a<C-g>u",
            key = "<C-b>",
            mode = { "i" },
            options = { desc = "Correct last spelling error", noremap = true, silent = true },
        },
        { action = "<Enter>", key = "<C-l>", mode = { "n", "i", "c" }, options = { noremap = true, silent = true } },
        {
            action = "<cmd>vsplit<Enter>",
            key = "<M-v>",
            mode = { "n" },
            options = { desc = "Create vsplit", noremap = true, silent = true },
        },
        {
            action = "<cmd>split<Enter>",
            key = "<M-s>",
            mode = { "n" },
            options = { desc = "Create hsplit", noremap = true, silent = true },
        },
        {
            action = "<C-w>k",
            key = "<M-k>",
            mode = { "n" },
            options = { desc = "Move to lower split", noremap = true, silent = true },
        },
        {
            action = "<C-w>j",
            key = "<M-j>",
            mode = { "n" },
            options = { desc = "Move to upper split", noremap = true, silent = true },
        },
        {
            action = "<C-w>l",
            key = "<M-l>",
            mode = { "n" },
            options = { desc = "Move to right split", noremap = true, silent = true },
        },
        {
            action = "<C-w>h",
            key = "<M-h>",
            mode = { "n" },
            options = { desc = "Move to left split", noremap = true, silent = true },
        },
        {
            action = "<C-w>+",
            key = "<M-K>",
            mode = { "n" },
            options = { desc = "Increase split size vertically", noremap = true, silent = true },
        },
        {
            action = "<C-w>-",
            key = "<M-J>",
            mode = { "n" },
            options = { desc = "Decrease split size vertically", noremap = true, silent = true },
        },
        {
            action = "<C-w>>",
            key = "<M-L>",
            mode = { "n" },
            options = { desc = "Increase split size horizontally", noremap = true, silent = true },
        },
        {
            action = "<C-w><",
            key = "<M-H>",
            mode = { "n" },
            options = { desc = "Decrease split size horizontally", noremap = true, silent = true },
        },
        {
            action = "<C-w>x",
            key = "<M-x>",
            mode = { "n" },
            options = { desc = "Swap splits", noremap = true, silent = true },
        },
        {
                ...
                do
                    local __nixvim_binds = {
                        ...
                        },
                        {
                            ...
                            key = "grf",
                            mode = "n",
                            options = { desc = "Lsp buf format", silent = false },
                        },
                        {
                            action = vim.lsp.buf.signature_help,
                            key = "grs",
                            mode = "n",
                            options = { desc = "Lsp buf signature_help", silent = false },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            key = "<Leader>lh",
                            mode = "n",
                            options = { desc = "Toggle inlay hints", noremap = true, silent = true },
                        },
                        {
                            action = function()
                            ...
                            key = "<Leader>ld",
                            mode = "n",
                            options = { desc = "Toggle inline LSP diagnostics", noremap = true, silent = true },
                        },
                        {
                            action = function()
